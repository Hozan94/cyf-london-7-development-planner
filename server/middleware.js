	...
	helmet({
		contentSecurityPolicy: {
			directives: {
                ...
                fontSrc: ["'self'", "https://fonts.googleapis.com/css?family=Roboto:300,400,500,700&display=swap"],
                iconSrc: ["'self'", "https://fonts.googleapis.com/icon?family=Material+Icons"],
